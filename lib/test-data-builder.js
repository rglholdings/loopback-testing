 ...
 */
TestDataBuilder.prototype.define = function(name, Model, properties, options) {
...
TestDataBuilder.prototype._buildObject = function(definition, callback) {
  ...
  definition.model.create(resolvedValues, options, function(err, result) {
    if (err) {
      console.error(
